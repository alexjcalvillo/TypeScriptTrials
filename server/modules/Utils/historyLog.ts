...
export class HistoryLog {
  ...
  public addNewEmployee(employee: Employee) {
    ...
    this.log.push(
      `${timeStamp} - ${employee.getFullName()} joined the team as a ${employee.getPosition()}, making ${salary} a year!`
    );
  }
  ...
  public promoteEmployee(employee: Employee) {
    ...
    const timeStamp = moment().format('lll');
    this.log.push(
      `${timeStamp} - ${employee.getFullName()} got PROMOTED, making ${salary}!`
    );
  }
